...
当我说【推送代码】，就依次执行：① 更新对话记录.md；② 同步进度追踪表、流程图、需求架构文档、README 等相关文件；③ 重新打包部署安装包；④ 提交 commit 并 push 源代码到 GitHub
---
...
3. 先问清楚三个问题再动手：
   ...
   - 核心痛点是什么？
   - 期望的体验是什么样？
4. **垃圾文件直接清理**：发现 0 字节杂散文件、乱码名文件、临时文件等垃圾，**当场删除**——不留待办、不汇报"遗留待确认"、不等用户批准（用户 2026-08-19 指定）
